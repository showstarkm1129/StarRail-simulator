...
Registry.character.add({
    ...
    partyEffects: [
        ...
        // ===== 星魂条件付き =====
        {
            ...
            source: 'eidolon',
            name: '雨上がり時 最大HP+50%',
            description: 'E1「闇夜の灯火を守って」: 雨上がり状態の時、味方の最大HPアップ効果がさらに上乗せ +50% として扱う (簡易: 味方全体 最大HP+50%)',
            stats: { [STAT.HP_PERCENT]: 0.50 },
            minEidolon: 1,
            defaultActive: false,
            target: 'all',
            duration: 2, tickRule: 'target_turn_end', dispellable: true,
        },
        {
            ...
            source: 'eidolon',
            name: 'HP減少時 速度+30% (2T)',
            description: 'E2「わたしの庭でくつろいで」: 味方のHPが減った時、その味方の速度+30%、2ターン継続',
        ...
        },
        {
            id: 'e6_res_pen',
            source: 'eidolon',
            name: '全属性耐性貫通+20% (常時発動)',
            description: 'E6「天空よ…願いを叶えたまえ」: イカルンがフィールド上にいる時、味方全体の全属性耐性貫通+20%',
